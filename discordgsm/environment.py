...
environment = Environment(
    [
        Variable(
            ...
            str,
            required=True,
            guide_link="https://discordgsm.com/guide/how-to-get-a-discord-bot-token",
        ),
        Variable(
            "WHITELIST_GUILDS",
            "Discord Guild ID, if more than one, separated by a semi colon ;",
            str,
            required=True,
        ),
        ...
        Variable(
            "APP_ACTIVITY_TYPE",
            "Presence activity type override. playing = 0, listening = 2, watching = 3, competing = 5",
            ActivityType,
            default=3,
        ),
        ...
        Variable(
            "APP_ADVERTISE_TYPE",
            "Presence advertise type. server_count = 0, individually = 1, player_stats = 2",
            AdvertiseType,
            default=0,
        ),
        Variable(
        ...
        Variable(
            ...
            "Query servers task timeout in seconds.",
            float,
            default=15,
        ),
        Variable(
            "DB_CONNECTION",
            "Database type. Accepted value: sqlite, pgsql, mongodb",
            str,
            default="sqlite",
        ),
        Variable("DATABASE_URL", "Database connection url.", str),
        Variable(
            "COMMAND_QUERY_PUBLIC",
            "Whether the /queryserver command should be available to all users.",
            bool,
            default=False,
        ),
        Variable(
            "COMMAND_QUERY_COOLDOWN",
            "The /queryserver command cooldown in seconds. (Administrator will not be affected)",
            float,
            default=5,
        ),
        ...
        Variable(
            "WEB_API_ENABLE",
            "Enable Web API feature. (Web server only)",
            bool,
            default=False,
        ),
        Variable(
            "FACTORIO_USERNAME",
            "The factorio username associated with the auth token.",
            str,
        ),
